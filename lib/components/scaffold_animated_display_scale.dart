// ScaffoldAnimatedDisplayScale — scale animated display.
//
...
/// Animates [child] with a scale effect.
///
...
/// animating.
class ScaffoldAnimatedDisplayScale extends StatefulWidget {
  /// Creates a [ScaffoldAnimatedDisplayScale].
  const ScaffoldAnimatedDisplayScale({
    super.key,
    required this.child,
    this.trigger,
    this.duration,
  ...
  @override
  State<ScaffoldAnimatedDisplayScale> createState() => _ScaffoldAnimatedDisplayScaleState();
}

class _ScaffoldAnimatedDisplayScaleState extends State<ScaffoldAnimatedDisplayScale>
  ...
  @override
  void didUpdateWidget(ScaffoldAnimatedDisplayScale oldWidget) {
