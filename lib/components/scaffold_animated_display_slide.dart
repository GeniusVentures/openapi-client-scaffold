// ScaffoldAnimatedDisplaySlide — slide animated display.
//
...
/// Animates [child] with a slide effect.
///
...
/// animating.
class ScaffoldAnimatedDisplaySlide extends StatefulWidget {
  /// Creates a [ScaffoldAnimatedDisplaySlide].
  const ScaffoldAnimatedDisplaySlide({
    super.key,
    required this.child,
    this.trigger,
    this.duration,
  ...
  @override
  State<ScaffoldAnimatedDisplaySlide> createState() => _ScaffoldAnimatedDisplaySlideState();
}

class _ScaffoldAnimatedDisplaySlideState extends State<ScaffoldAnimatedDisplaySlide>
  ...
  @override
  void didUpdateWidget(ScaffoldAnimatedDisplaySlide oldWidget) {
